                ...
                <div class="tm-main uk-width-medium-3-4">
                    ...
                    <main class="tm-content">
                        ...
                        <ul class="uk-breadcrumb">
                            ...
                            <li class="uk-active"><span>Add Match</span></li>
                        </ul>
                        ...
                        <div class="login">
                            ...
                            <form action="source/add.php" method="post"
                                  class="form-validate form-horizontal well">

                                <fieldset>
                                    <div class="control-group">
                                        <div class="control-label">
                                            <label id="username-lbl" for="date" class="required">
                                                Date<span class="star">&#160;*</span></label>
                                        </div>
                                        <div class="controls">
                                            <input type="text" name="date" id="date" class="validate-username required" size="25" required aria-required="true"/>
                                        </div>
                                    </div>

                                    <div class="control-group">
                                        <div class="control-label">
                                            <label id="username-lbl" for="home" class="required">
                                                Home<span class="star">&#160;*</span></label>
                                        </div>
                                        <div class="controls">
                                            <input type="text" name="home" id="home" class="validate-username required" size="25" required aria-required="true"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        <div class="control-label">
                                            <label id="username-lbl" for="odd" class="required">
                                                ODD<span class="star">&#160;*</span></label>
                                        </div>
                                        <div class="controls">
                                            <input type="text" name="odd" id="odd" class="validate-username required" size="25" required aria-required="true"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        <div class="control-label">
                                            <label id="username-lbl" for="away" class="required">
                                                Away<span class="star">&#160;*</span></label>
                                        </div>
                                        <div class="controls">
                                            <input type="text" name="away" id="away" class="validate-username required" size="25" required aria-required="true"/>
                                        </div>
                                    </div>

                                    <div class="control-group">
                                        <div class="control-label">
                                            <label id="username-lbl" for="tips" class="required">
                                                Tips<span class="star">&#160;*</span></label>
                                        </div>
                                        <div class="controls">
                                            <input type="text" name="tips" id="tips" class="validate-username required" size="25" required aria-required="true"/>
                                        </div>
                                    </div>

                                    <div class="control-group">
                                        <div class="control-label">
                                            <label id="username-lbl" for="score" class="required">
                                                Home<span class="star">&#160;*</span></label>
                                        </div>
                                        <div class="controls">
                                            <input type="text" name="score" id="score" class="validate-username required" size="25" required aria-required="true"/>
                                        </div>
                                    </div>
